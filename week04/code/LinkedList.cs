...
public class LinkedList : IEnumerable<int> {
    ...
    public void InsertTail(int value) {
        ...
        // Create new node
        Node newNode = new Node(value);
        // If list is empty then set both Head and Tail to new node
        if (_tail is null)
        {
            _head = newNode;
            _tail = newNode;
    ...
    public void RemoveTail() {
        // TODO Problem 2
        //If list contains only one item set head and tail to null
        if(_tail == _head)
        {
            _head = null;
            _tail = null;
    ...
    public void Remove(int value) {
        ...
        // if(lastOne)
        // {
        //     Console.WriteLine($"_head: {_head}, _tail: {_tail}");
        // }
    }
